...
import jsonServerProvider from "ra-data-json-server";
import { Admin } from "@/components/admin/admin/admin";
import { ListGuesser } from "@/components/admin/admin/list-guesser";
import { ShowGuesser } from "@/components/admin/admin/show-guesser";
import { EditGuesser } from "@/components/admin/admin/edit-guesser";
