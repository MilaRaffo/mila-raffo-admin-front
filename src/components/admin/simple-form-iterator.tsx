 ...
 *
 * @example
 * import { ArrayInput, SimpleFormIterator, TextInput } from '@/components/admin/admin';
 *
 * const PostEdit = () => (
 ...
 *
 * @example
 * import { SimpleFormIteratorItem } from '@/components/admin/admin';
 *
 ...
 *
 * @example
 * import { ArrayInput, SimpleFormIterator, AddItemButton } from '@/components/admin/admin';
 *
 * const PostEdit = () => (
 ...
 *
 * @example
 * import { SimpleFormIterator, ReOrderButtons } from '@/components/admin/admin';
 *
 * const PostEdit = () => (
 ...
 *
 * @example
 * import { ClearArrayButton } from '@/components/admin/admin';
 *
 * // Typically used internally by SimpleFormIterator
 */
 ...
 *
 * @example
 * import { SimpleFormIterator, RemoveItemButton } from '@/components/admin/admin';
 *
 * const PostEdit = () => (
